...
sessionStorage.setItem(
  ...
  JSON.stringify({
    ...
    forName: generatorState.forName
  })
);
...
function showLove() {
  const messages = [
    ...
    `⭐ You are the most beautiful star in my life ⭐\nThe one who always lights up every step I take`,
    `💑 With you, every day feels like Valentine’s Day 💑\nBecause your love makes my life perfect`,
...
My life is more beautiful because there is you!`,
    `🌹 Our love is like a flower that always blooms, it will never wither 🌹
You are the fragrance of flowers that always stays in my heart`,
    `✨ You are a dream come true ✨
When I close my eyes, I only see you`,
    `🌟 You are the light in my life, brighter than the stars 🌟\nEvery day with you is a blessing`,
    `💌 There are not enough words to describe my love 💌 Every second with you is priceless happiness`,
    `🌸 My heart belongs to you 🌸\nThere is nothing more beautiful than your love`,
    `💖 You are the home of my heart 💖\nThe place I return to, the place where I feel safe and loved`,
    `💓 Every touch you make this world feel more beautiful 💓
Your love is the power that makes me live`,
    `🌷 You are priceless beauty 🌷\nEvery look from you is happiness for me`,
    `🌹 Your presence makes this world sweeter 🌹
\nYou are the reason I smile every day`,
    `💞 Your love is the greatest gift in my life 💞
Nothing can separate us!`,
    `💖 You are the home of my heart 💖
Where I return, where I feel safe and loved`,
    `💘 You are my beating heart 💘
And I want to live with you forever`,
    `🌟 There is nothing more beautiful than our love 🌟
You are the best part of my life`,
    `💎 Our love is more precious than diamonds 💎\nEvery second with you is an unforgettable memory`,
    `🦋 Every moment with you feels like flying above the clouds 🦋\nYou are my happiness.`,
    `🌻 With you, I feel like a flower that always blooms 🌻\nYour love is everything in my life`,
    `💖 Our love is a journey that will never end 💖
Every step I take always leads to you`,
    `💓 You are the strength in my life 💓\nWhen you are near me, I feel like I can conquer the world`,
    `💑 With you, this life is full of laughter and happiness 💑\nYou are the best friend, the best lover, and everything to me`,
    `🌸 My heart is yours 🌸
There is nothing more beautiful than your love`,
...
Your love is everything I need`,
  ...
  swal({
    ...
    buttons: {
      cancel: "Close",
      confirm: {
        text: "Send Love Message via WhatsApp",
        value: true,
      },
    },
  }).then((value) => {
...
function updateLoveCounter() {
  ...
  document.getElementById("loveCounter").innerHTML = `
        <p style="font-size: 1.5em; margin: 10px 0;">
            ${diffDays} Days Full Of Love ❤️<br />I Love Youuuuuuuuuu
        </p>
    `;
}
...
// music_list = document.querySelectorAll(".src");
// music_list.forEach((item) => {
//   item.addEventListener("click", function () {
//     console.log(this.src);
//     const song = this.querySelector("src");
